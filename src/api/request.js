...
import setConfig from "./request.setConfig";
import handleResponse from "./request.handleResponse";
...
/**
 * intactRequest 是只在 axios 基础上更改了请求配置。
 * 而 request 是基于 axios 创建的实例，实例只有常见的数据请求方法，没有axios.isCancel/ axios.CancelToken等方法，
...
export default { intactRequest, request };
